...
var AuthService = function () {
    ...
    var AuthService = _classThis = /** @class */ (function () {
        ...
        AuthService_1.prototype.signIn = function (_username, _password) {
                    ...
                    switch (_b.label) {
                        ...
                        case 3:
                            if (_a) {
                                ...
                                return [2 /*return*/, result]; // Retorna o usuário sem a senha
                            }
        ...
        AuthService_1.prototype.login = function (user) {
            var payload = { email: user.email, sub: user.id };
            return {
